...
export default function Settings() {
  ...
  return (
    <div className="container-fluid py-4" style={{ maxWidth: 700 }}>
      <h1 className="h3 mb-4 fw-bold text-center">Settings</h1>
      {success && (
      ...
      <div className="card shadow-sm p-4 mb-4">
        ...
        <div className="d-flex align-items-center mb-3">
          <div className="rounded-circle bg-secondary d-flex align-items-center justify-content-center me-3" style={{ width: 64, height: 64, fontSize: 32, color: '#fff' }}>
            👤
          </div>
          <div>
        ...
        <div className="alert alert-info py-2 px-3 mb-0" style={{ fontSize: '0.95rem' }}>
          For changes to your profile information, please contact your department or visit your profile page.
        </div>
      </div>
