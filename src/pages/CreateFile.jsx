...
import { createFile } from '../services/dataServices';
...
export default function CreateFile() {
  ...
  const handleSubmit = (e) => {
    ...
    const fileData = {
      title: title.trim(),
      department,
      priority: importance, // Keep as priority for backward compatibility
      importance, // Add new importance field
      isDigital,
          ...
          <div className="content-card">
            ...
            <div className="content-card-body">
              <div className="text-center mb-4">
                ...
                <div className="mt-2">
                  <span className={`badge badge-${getImportanceColor(importance)}`}>
                    {importance}
                  </span>
                </div>
              </div>
